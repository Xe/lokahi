...
func NewRunLocalProtobufClient(addr string, client *http.Client) RunLocal {
...
func (c *runLocalProtobufClient) Checks(ctx context.Context, in *CheckIDs) (*Run, error) {
	url := c.urlBase + RunLocalPathPrefix + "Checks"
	out := new(Run)
...
func NewRunLocalJSONClient(addr string, client *http.Client) RunLocal {
